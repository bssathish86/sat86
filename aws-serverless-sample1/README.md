# aws-serverless-sample1 serverless API
The aws-serverless-sample1 project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=aws-serverless-sample1 -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3.1 -DgroupId=com.java.test -Dversion=0.0.1-SNAPSHOT -Dinteractive=false
$ cd aws-serverless-sample1
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "AwsServerlessSample1Api",
                    "OutputKey": "AwsServerlessSample1Api",
